...
sed 's/change_mass_density/'"$mass_density"'/g' ~/python/find_stopping.py > ./find_stopping.py 
...
do 
    ...
    sed 's/change_energy/'"$energies"'/g' ../find_stopping.py > ./find_stopping.py 
   ...
   do 
     ...
     rm stopping_power.txt

     sed 's/change_thickness/'"$thickness_val"'/g' ../find_stopping.py > ./find_stopping.py 
