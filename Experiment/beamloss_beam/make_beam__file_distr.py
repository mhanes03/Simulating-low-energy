# Purpose : create beam file for the positron simulation for the experiment, removing the entries with a Nan and changing the z value of those outside the cell. Introducing an x and y distribution to the muons that left the cell
# 
