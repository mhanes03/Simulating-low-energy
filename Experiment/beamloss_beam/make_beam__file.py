# Purpose : create beam file for the positron simulation for the experiment, removing the entries with a Nan and changing the z value of those outside the cell 
# 
