...
def func_g4(bounds):
	...
	path = fr'/home/mh1163604/experiment/g4_beamline/shorter_gas_cell/optimise_pressure_e_field/volt_{str(voltage)}_density_{str(density)}'
	path_main = '/home/mh1163604/experiment/g4_beamline/shorter_gas_cell/optimise_pressure_e_field/'
	...
	g4_calc = subprocess.Popen(fr'apptainer run --app g4blmpi ~/g4blmpi_muoncooling_20250821.sif 16 input.g4bl Pressure={p/760} E_field_magnitude={voltage} He_density={density} > g4_out', shell=True)
	...
	if os.path.getsize(fr'/home/mh1163604/experiment/g4_beamline/shorter_gas_cell/optimise_pressure_e_field/volt_{str(voltage)}_density_{str(density)}/{file}') == 121 :
		N = 0 
		N_eqm = 0 
		N_less = 0
		os.chdir(path_main)
