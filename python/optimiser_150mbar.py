...
def func_g4(bounds):
	...
	path = fr'/mnt/ceph/home/mh1163604/experiment/optimise_4cm_200/different_pressures_optimisations/150mbar/volt_{str(volt)}'
	path_main = '/mnt/ceph/home/mh1163604/experiment/optimise_4cm_200/different_pressures_optimisations/150mbar/'
	...
	if os.path.getsize(fr'/mnt/ceph/home/mh1163604/experiment/optimise_4cm_200/different_pressures_optimisations/150mbar/volt_{str(volt)}/{file}') == 121 :
		N = 0 
		N_eqm = 0 
		N_less = 0
		os.chdir(path_main)
