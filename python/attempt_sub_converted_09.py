...
with open(file_name, 'a') as f:
		f.write('#'+ param_to_be_optimised_1 + ' ' + param_to_be_optimised_2 + ' ' + 'volt' + ' ' + 'density' + ' ' + 'pressure' + ' ' + 'N_great' +  ' ' + 'N_less' + '\r\n')
f.close()
...
def func_g4(bounds):
	...
	path = fr'/home/mh1163604/low_energy/making_stopping_curves/Sandwich_in_SRIM/trim/1/chris_cooling/moving_decelerating/tuning_time_1/10_ns_reacc/using_python/dc_cell/vary_density_volt_2/between_0.9/volt_{str(voltage)}_density_{str(density)}'
	path_main = '/home/mh1163604/low_energy/making_stopping_curves/Sandwich_in_SRIM/trim/1/chris_cooling/moving_decelerating/tuning_time_1/10_ns_reacc/using_python/dc_cell/vary_density_volt_2/between_0.9/'
	...
	with open(file_name, 'a') as f:
		f.write(str(bounds[0]) + ' ' + str(bounds[1]) + ' ' + str(voltage) + ' ' + str(density) + ' ' + str(p/760) + ' ' + str(N) + ' ' +  str(N_less) + '\r\n')
	f.close()
