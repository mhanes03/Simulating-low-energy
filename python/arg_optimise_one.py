...
def func_g4(bounds):
	...
	path = fr'/home/mh1163604/low_energy/making_stopping_curves/Sandwich_in_SRIM/trim/1/chris_cooling/moving_decelerating/tuning_time_1/10_ns_reacc/using_python/dc_cell/over_300mm/with_arg/volt_{str(voltage)}'
	path_main = '/home/mh1163604/low_energy/making_stopping_curves/Sandwich_in_SRIM/trim/1/chris_cooling/moving_decelerating/tuning_time_1/10_ns_reacc/using_python/dc_cell/over_300mm/with_arg/'
	...
	with open(file_name, 'a') as f:
		f.write(str(bounds[0]) + ' ' + str(N) + ' ' +  str(N_eqm) + '\r\n')
	f.close()
