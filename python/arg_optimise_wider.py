...
with open(file_name, 'a') as f:
		f.write('#'+ 'volt' + ' ' + 'N_not_eqm' +  ' ' + 'N_less_eqm' + ' ' + 'N_eqm' + '\r\n')
f.close()
...
def func_g4(bounds):
	...
	path = fr'/home/mh1163604/low_energy/making_stopping_curves/Sandwich_in_SRIM/trim/1/chris_cooling/moving_decelerating/tuning_time_1/10_ns_reacc/using_python/dc_cell/over_300mm/with_arg/smaller/volt_{str(voltage)}'
	path_main = '/home/mh1163604/low_energy/making_stopping_curves/Sandwich_in_SRIM/trim/1/chris_cooling/moving_decelerating/tuning_time_1/10_ns_reacc/using_python/dc_cell/over_300mm/with_arg/smaller'
	...
	g4_calc = subprocess.Popen(fr'apptainer run --app g4blmpi ~/g4blmpi_muoncooling_20250821.sif 16 input.g4bl E_field_magnitude={voltage} > g4_out', shell=True)
	...
	with open(file_name, 'a') as f:
		f.write(str(bounds[0]) + ' ' + str(N) + ' ' + str(N_less) + ' ' + str(N_eqm) + '\r\n')
	f.close()
