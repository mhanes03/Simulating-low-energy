...
def func_g4(bounds):
    ...
    # In MeV cm**2/g for about 700 eV eqm
	stp = 208.7

	voltage = bounds[0]*stp*density*100

	path = fr'/home/mh1163604/low_energy/making_stopping_curves/Sandwich_in_SRIM/trim/1/chris_cooling/moving_decelerating/tuning_time_1/10_ns_reacc/using_python/dc_cell/consider_stopping_power/volt_{str(voltage)}_density_{str(density)}'
	path_main = '/home/mh1163604/low_energy/making_stopping_curves/Sandwich_in_SRIM/trim/1/chris_cooling/moving_decelerating/tuning_time_1/10_ns_reacc/using_python/dc_cell/consider_stopping_power/'
