...
param_to_be_optimised = 'density'

with open(file_name, 'a') as f:
		f.write('#'+ param_to_be_optimised + ' ' + 'N_great' +  ' ' + 'N_less' + '\r\n')
f.close()
...
def func_g4(bounds):
	...
	g4_calc = subprocess.Popen(fr'apptainer run --app g4blmpi ~/g4blmpi_muoncooling_20250821.sif 16 cooling.g4bl density_he={bounds[0]} > g4_out', shell=True)
...
bounds = [(8.4E-7,8.4E-6)]

# carries out the optimisation 
result = differential_evolution(func_g4, bounds,maxiter=10,updating='immediate',seed=)
