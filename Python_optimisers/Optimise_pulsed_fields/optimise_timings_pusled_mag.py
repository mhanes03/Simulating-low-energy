# Purpose : using differential evolution optimiser to optimise the cell for timings of pulsed fields and the magnitude of the forward and backward fields
#
# Input : bounds for the timings, and the magnitude of the fields 
...
param_to_be_optimised_2 = 'forward_field'
param_to_be_optimised_3 = 'backward_field'

with open(file_name, 'a') as f:
		f.write('#'+ param_to_be_optimised_1 + ' ' + param_to_be_optimised_2 + ' ' + param_to_be_optimised_3 + ' ' + 'N_not_eqm' +  ' ' + 'N_less_eqm' + ' ' + 'N_eqm' + ' ' + 'less_500eV_unique_event' '\r\n')
f.close()
...
def func_g4(bounds):
	...
	path = fr'/mnt/ceph/home/mh1163604/looking_at_pulsed_detail/01_07_2026/timed_fields/optimise_timing_field/timings_{str(bounds[0])}_ezpos_{bounds[1]}_ezneg_{bounds[2]}'
	path_main = '/mnt/ceph/home/mh1163604/looking_at_pulsed_detail/01_07_2026/timed_fields/optimise_timing_field/'
	...
	g4_calc = subprocess.Popen(fr'apptainer run --app g4blmpi ~/g4blmpi_muoncooling_20250821.sif 16 input.g4bl neg_flatop={bounds[0]} ez_pos={bounds[1]} ez_neg={bounds[2]} > g4_out', shell=True)
	...
	if os.path.getsize(fr'/mnt/ceph/home/mh1163604/looking_at_pulsed_detail/01_07_2026/timed_fields/optimise_timing_field/timings_{str(bounds[0])}_ezpos_{bounds[1]}_ezneg_{bounds[2]}/{file}') == 121 :
		N = 0 
		N_eqm = 0 
		N_less = 0
		os.chdir(path_main)
		...
		with open(file_name, 'a') as f:
			f.write(str(bounds[0]) + ' ' + str(bounds[1]) + ' ' + str(bounds[2]) + ' ' + str(N) + ' ' + str(N_less) + ' ' + str(N_eqm) + '\r\n')
		f.close()
...
bounds = [(100, 1000), (0.01, 0.04), (0.01, 0.04)]
